...
document.addEventListener('DOMContentLoaded', function() {
    ...
    travelForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            let flightData = null;
            // Hotel data to be included in the plan
            let hotelData = null;
            ...
            // Mock hotel data (OYO and others)
            hotelData = {
                "hotels": [
                    {
                        "name": "OYO Townhouse ",
                        ...
                        "image": "https://images.oyoroomscdn.com/uploads/hotel_image/123456/large.jpg",
                        "amenities": ["Free WiFi", "Breakfast Included", "AC", "24x7 Reception"]
                    },
                    {
                        ...
                        "amenities": ["Pool", "Free Parking", "Gym", "Restaurant"]
                    },
                    {
                        "name": "Budget Inn",
                        "brand": "Budget",
                        ...
                        "currency": "USD",
                        "rating": 3.8,
                        "address": `Near ${destination} Station`,
            ...
            // Add hotel data to the prompt
            if (hotelData && hotelData.hotels) {
                prompt += `\n\nHere are some hotel options (including OYO) to include in the accommodation section:\n`;
                hotelData.hotels.forEach((hotel, index) => {
                    prompt += `Option ${index + 1}: ${hotel.name} (${hotel.brand}) - ${hotel.price} per night - Rating: ${hotel.rating}/5 - Address: ${hotel.address} - Amenities: ${hotel.amenities.join(", ")}\n`;
                });
            }
            ...
            if (data.candidates && data.candidates.length > 0 && data.candidates[0].content) {
                ...
                displayTravelPlan(generatedText, flightData, hotelData);
            } else {
    ...
    function displayTravelPlan(planText, flightData, hotelData) {
        ...
        // Add hotel details in a visually appealing way if available
        if (hotelData && hotelData.hotels && hotelData.hotels.length > 0) {
            let hotelHTML = `
                <div class="hotel-details">
                    <h3><i class="fas fa-hotel"></i> Hotel Options</h3>
                    ...
                    <div class="hotel-card">
                        ...
                        <div class="hotel-info">
                            <div class="hotel-header">
                                ...
                                <span class="hotel-brand">${hotel.brand}</span>
                            </div>
                            <div class="hotel-meta">
                                <span class="hotel-price">${hotel.price}/night</span>
                                <span class="hotel-rating"><i class="fas fa-star"></i> ${hotel.rating}</span>
                            </div>
            ...
            `;
            // Insert hotel details at the beginning of the plan content
            planHTML = planHTML.replace('<div class="plan-content">', '<div class="plan-content">' + hotelHTML);
        }
